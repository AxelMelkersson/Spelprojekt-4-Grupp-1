...
void OptionsMenu::Init()
{
	...
	v2f tutorialPos = { 140.f, 120.f };
	v2f backPos = { 140.f, 140.f };
	v2f resetPos = { 30.f, 160.f };
	v2f soundSettingPos = { 215.f, 80.f };
	v2f bgDot = { 215.f + (myMusicVol * 74.f), 87.5f };
	v2f SFXDot = { 215.f + (mySFXVol * 74.f), 104.5f };
