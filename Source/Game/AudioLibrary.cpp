...
AudioLibrary::AudioLibrary()
{
	...
	myAudioList.insert_or_assign(AudioList::CollectibleGone, new AudioClip("Sounds/Effects/CollectibleGone.wav",  false, 0.2f, 0.4f, AudioLayer::SoundEffect));
	...
	myAudioList.insert_or_assign(AudioList::HoverActivate,   new AudioClip("Sounds/Effects/HoverActivate.wav",    false, 0.2f, 0.6f, AudioLayer::SoundEffect));
	...
	myAudioList.insert_or_assign(AudioList::WalkBrickLeft,   new AudioClip("Sounds/Effects/Step_Bricks_Left.wav", false, 0.4f, 0.8f,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkWoodRight,   new AudioClip("Sounds/Effects/Step_Wood_Right.wav",  false, 0.4f, 0.8f,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkWoodLeft,    new AudioClip("Sounds/Effects/Step_Wood_Left.wav",   false, 0.4f, 0.8f,    AudioLayer::SoundEffect));
	myAudioList.insert_or_assign(AudioList::WalkStoneRight,  new AudioClip("Sounds/Effects/Step_Stone_Right.wav", false, 0.4f, 0.8f,    AudioLayer::SoundEffect));
	...
	myAudioList.insert_or_assign(AudioList::WeakPlatform,    new AudioClip("Sounds/Effects/TemporaryPlatform.wav",false, 0.2f, 0.5f, AudioLayer::SoundEffect));
